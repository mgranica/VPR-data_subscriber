...
def create_spark_session(aws_access_key_id, aws_secret_access_key, cores_number="2"):
    ...
    try:
        ...
        conf = (
            ...
            .set(
                "spark.jars.packages", 
                "io.delta:delta-core_2.12:2.4.0,org.apache.hadoop:hadoop-aws:3.3.2,org.apache.spark:spark-streaming-kinesis-asl_2.12:3.4.2,com.amazonaws:aws-java-sdk-kinesis:1.11.900"
            )
